...
const Product = {
    ...
    handleRenderProduct: function () {
        ...
        addToCart.onclick = function () {
            ...
            console.log(_this.statusColor, "co", _this.statusSize, "size", _this.quantityProduct, "quan")
            let nameProduct = $('.btn__add_item').parentNode.parentNode.querySelector('.name__infor_product').textContent;
            let priceProduct = $('.btn__add_item').parentNode.parentNode.querySelector('.price').textContent;
            let imgProduct = $('.btn__add_item').parentNode.parentNode.parentNode.querySelector('.mImage').src;
            let product = { name: nameProduct, price: priceProduct, color: _this.statusColor, size: _this.statusSize, quantity: _this.quantityProduct, img: imgProduct}
